...
ARG DOCUMENT_TOKEN=build-placeholder
ENV DOCUMENT_TOKEN=$DOCUMENT_TOKEN
ARG DOCUMENT_ACCESS_SECRET=build-placeholder
ENV DOCUMENT_ACCESS_SECRET=$DOCUMENT_ACCESS_SECRET
