...
export function SelectInput({ field, register, error }: Props) {
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <select
        ...
        {...register(field.name)}
        className="border border-[var(--color-foues-border-input)] rounded px-3 py-2 text-sm text-[var(--color-foues-input-text)] bg-[var(--color-foues-input-bg)] focus:outline-none focus:ring-2 focus:ring-[var(--color-foues-input-focus-ring)] disabled:bg-[var(--color-foues-surface-sunken)]"
      >
